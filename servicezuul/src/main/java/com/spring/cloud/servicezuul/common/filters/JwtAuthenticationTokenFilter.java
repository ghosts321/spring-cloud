package com.spring.cloud.servicezuul.common.filters;

import com.alibaba.fastjson.JSON;
import com.spring.cloud.servicezuul.common.enums.ResultEnum;
import com.spring.cloud.servicezuul.common.utils.*;
import com.spring.cloud.servicezuul.common.vo.ResultVO;
import com.spring.cloud.servicezuul.moudles.user.JwtUserDetailsServiceImpl;
...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            String username = JwtTokenUtils.parseToken(authToken, "_secret");
            ...
            if (redisUtil.hasKey(authToken)) {//判断redis是否有保存
                ...
                if (JwtTokenUtils.isExpiration(expirationTime)) {
                    ...
                    redisUtil.hset("blacklist", authToken, DateUtils.getTime());

                    if (DateUtils.compareDate(currentTime, tokenValidTime)) {
                        ...
                        map.put("ip", ip);
                        String jwtToken = JwtTokenUtils.generateToken(usernameByToken, expirationSeconds, map);
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                 ...
                 * 如果ip不正确，进入黑名单验证
                 */
                if (!StringUtils.equals(ip, currentIp)) {//地址不正确
